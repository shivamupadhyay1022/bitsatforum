          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="px-16">
              ...
              <p className="text-md text-gray-700 mb-6">
                ...
                deemed university. Founded in 1964, BITS Pilani has consistently
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center px-16">
            ...
            <div>
              ...
              <p className="text-md text-gray-700 mb-4">
                As a BITS Pilani alumnus, our founder recognized the challenges
                students face while preparing for BITSAT. This platform was born
                from a vision to make quality BITSAT preparation accessible to
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 ">
              ...
              <div className="bg-white p-2 pt-4 rounded-xl">
                ...
                <p className="text-sm text-start p-2 text-gray-700">
                  ...
                  helping thousands of students achieve their dreams of studying
                  at BITS Pilani.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <ul className="text-gray-700 pl-6 text-sm">
                  <li className="mb-2 flex"><PeopleLogo/>Previous Year Papers</li>
                  <li className="mb-2 flex"><PeopleLogo/>Basic Performance Analytics</li>
                  <li className="mb-2 flex"><PeopleLogo/>Topic-wise Practice</li>
                  <li className="mb-2 flex"><PeopleLogo/>Limited Mock Tests</li>
                </ul>
                <div className="mt-6">
                  <LearnMoreButton />
                </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <ul className="text-gray-700 pl-6 text-sm">
                  <li className="mb-2 flex"><PeopleLogo/>All Basic Features</li>
                  <li className="mb-2 flex"><PeopleLogo/>Unlimited Mock Tests</li>
                  <li className="mb-2 flex"><PeopleLogo/>Detailed Solutions</li>
                  <li className="mb-2 flex"><PeopleLogo/>Performance Tracking</li>
                </ul>
                <div className="mt-6">
                  <LearnMoreButton />
                </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <ul className="text-gray-700 pl-6 text-sm">
                  <li className="mb-2 flex"><PeopleLogo/>All Premium Features</li>
                  <li className="mb-2 flex"><PeopleLogo/>Personalized Study Plan</li>
                  <li className="mb-2 flex"><PeopleLogo/>Expert Guidance</li>
                  <li className="mb-2 flex"><PeopleLogo/>Live Doubt Solving</li>
                </ul>
                <div className="mt-6">
                  <LearnMoreButton />
                </div>
